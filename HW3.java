...
//
    ...
    Pair<String, String> parse_rule(String rule) {
        if (rule.endsWith("$")) {
    ...
    boolean check_url(String url, Pair<String, String> rule) {
        if (rule.getFirst().equals("/") && url.startsWith(rule.getSecond())) {
            return true;
        } else if (r.getFirst().equals("*") && url.contains(r.getSecond())) {
            return true;
        } else if (r.getFirst().equals("$") && url.endsWith(r.getSecond())) {
            return true;
        } else if (r.getFirst().equals("/$") && url.equals(r.getSecond())) {
            return true;
        } else if (r.getFirst().equals("*$") && url.endsWith(r.getSecond())) {
            return true;
        }
